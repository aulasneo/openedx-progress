...
"""
openedx-progress documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-progress',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/aulasneo/openedx-progress",
...
#
# html_title = 'openedx-progress v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Progress tracking for Open edX students',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_progress'),
                os.path.join(root_path, 'openedx_progress/migrations')])
